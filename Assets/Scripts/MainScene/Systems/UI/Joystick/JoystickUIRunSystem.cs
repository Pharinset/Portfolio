        ...
        public void Run()
        {
            foreach (var i in _filter)
            {
                ...
                if (Input.touchCount > 0)
                {
                    ...
                    {
                        joystickUIComponent.SecondTouchPosition = Input.GetTouch(0).position;
                        joystickUIComponent.Body.position = new Vector3
                                            (joystickUIComponent.FirstTouchPosition.x + joystickUIComponent.TouchDirection.x,
                    ...
                    {
                        joystickUIComponent.TouchOffset = 
                            joystickUIComponent.SecondTouchPosition - joystickUIComponent.FirstTouchPosition;
